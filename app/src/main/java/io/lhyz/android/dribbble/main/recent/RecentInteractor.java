 ...
 */
public class RecentInteractor extends Interactor<List<Shot>> {

    DribbbleRepository mRepository;

    @Inject
    public RecentInteractor(ThreadExecutor threadExecutor,
    ...
    protected Observable<List<Shot>> buildObservable() {
        return mRepository.getShotList(ShotType.RECENT);
    }
}
