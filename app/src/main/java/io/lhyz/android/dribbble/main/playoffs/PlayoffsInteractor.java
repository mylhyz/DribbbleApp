 ...
 */
public class PlayoffsInteractor extends Interactor<List<Shot>> {

    DribbbleRepository mRepository;

    @Inject
    public PlayoffsInteractor(ThreadExecutor threadExecutor,
    ...
    protected Observable<List<Shot>> buildObservable() {
        return mRepository.getShotList(ShotType.PLAYOFFS);
    }
}
